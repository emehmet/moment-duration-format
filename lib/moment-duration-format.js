...
(function (root, factory) {
		...
		var formatValue = function (momentType, index) {
			...
			if (
				...
				(momentType.significantDigits &&
					momentType.significantDigits - momentType.wholeValue.toString().length <= 0)
			) {
				...
				if (useSignificantDigits && momentType.wholeValue) {
					...
					momentType.value = Math.round(
						truncate(
							...
							momentType.significantDigits - momentType.wholeValue.toString().length
						)
					);
	...
	function init(context) {
		...
		context.defineLocale('en', engLocale);
	}
